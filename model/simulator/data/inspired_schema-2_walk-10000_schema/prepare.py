...
path_data_dir = '../../../../data/inspired-meta'
with open(f'{path_data_dir}/entity2type.json', encoding='utf-8') as f:
    entity2type = json.load(f)
with open(f'{path_data_dir}/id2metapath.json', encoding='utf-8') as f:
...
with open(f'../inspired_schema-2_walk-10000_flow/train_data_processed.jsonl', encoding='utf-8') as f:
    for line in tqdm(f):
