...
class BartForFlowGeneration(BartPretrainedModel):
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        if 'decoder_logits_mask' in model_kwargs:
            model_kwargs['decoder_logits_mask'] = model_kwargs['decoder_logits_mask'].index_select(0, expanded_return_idx)
    ...
    def forward(
        ...
        if labels is not None:
            ...
            if reduction == 'none':
                masked_lm_loss = masked_lm_loss.reshape(batch_size, seq_len)
