...
from dataloader_unicrs import UniCRSDataCollatorForPreTraining
...
if __name__ == '__main__':
    ...
    valid_dataset = DatasetForRec(
        valid_data_list, tokenizer=tokenizer, prompt_tokenizer=text_tokenizer, debug=args.debug, shot=args.shot,
        context_max_length=args.max_length, resp_max_length=args.resp_max_length,
        entity2id=kg['entity2id'], entity_max_length=args.entity_max_length
    )
    ...
    test_dataset = DatasetForRec(
        test_data_list, tokenizer=tokenizer, prompt_tokenizer=text_tokenizer, debug=args.debug, shot=args.shot,
        context_max_length=args.max_length, resp_max_length=args.resp_max_length,
        entity2id=kg['entity2id'], entity_max_length=args.entity_max_length
    )

    data_collator = UniCRSDataCollatorForPreTraining(
        tokenizer=tokenizer, prompt_tokenizer=text_tokenizer, context_max_length=args.max_length + args.resp_max_length,
