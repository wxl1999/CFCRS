...
if __name__ == '__main__':
    ...
    with open('../redial-meta/id2metapath.json', encoding='utf-8') as f:
        id2metapath = json.load(f)
        metapath_set = set(map(tuple, id2metapath.values()))

    with open('../redial/entity2id.json', encoding='utf-8') as f:
        entity2id = json.load(f)

    with open('../redial/entity2type.json', encoding='utf-8') as f:
    ...
    with open('../redial/kg.json', encoding='utf-8') as f:
        kg = json.load(f)
